...
from api.db.services.canvas_service import (API4ConversationService,
...
from api.db.services.task_service import (CANVAS_DEBUG_DOC_ID, TaskService,
                                          queue_dataflow)
...
@login_required
def prompts():
    from rag.prompts.generator import (ANALYZE_TASK_SYSTEM, ANALYZE_TASK_USER,
                                       CITATION_PROMPT_TEMPLATE, NEXT_STEP,
                                       REFLECT)
    return get_json_result(data={
